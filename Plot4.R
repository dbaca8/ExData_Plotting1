...
## 3. Create 4 plots on 1 page: Global_active_power vs. time, Voltage vs. time,
##    all Sub_metering vs. time, and Global_reactive_power vs. time
...
## 4 plots on 1 page: Global_active_power vs. time, Voltage vs. time,
##    all Sub_metering vs. time, and Global_reactive_power vs. time
png("plot4.png", width=480, height=480)
par(mfrow=c(2,2))
with(datasub, plot(Date_Time, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(datasub, plot(Date_Time, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(datasub, plot(Date_Time, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
lines(datasub$Date_Time, datasub$Sub_metering_2,type="l", col= "red")
lines(datasub$Date_Time, datasub$Sub_metering_3,type="l", col= "blue")
legend(c("topright"), c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty= 1, lwd=1, col = c("black", "red", "blue"))
with(datasub, plot(Date_Time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()