...
## 3. Create a plot of 3 Sub_metering variables vs time
...
## Plot of 3 Sub_metering variables vs time
png("plot3.png", width=480, height=480)
with(datasub, plot(Date_Time, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
