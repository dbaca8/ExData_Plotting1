...
## 3. Create histogram plot of Global_active_power (kilowatts) vs Frequency
...
## Plot png histogram of Global_active_power vs Frequency for those 2 days
png(file="plot1.png", width=480, height=480)
hist(datasub$Global_active_power, col="red", border="black", main ="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency")
dev.off()